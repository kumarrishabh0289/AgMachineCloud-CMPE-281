...
class SensorManageComponent extends Component {
    ...
    onClickDelete = param => e =>{
        ...
        axios.patch(API_URL + '/sensor/update', data)
            .then((response) => {
    ...
    render() {
        ...
        let allSensors = this.state.allSensors.map(topic => {
            ...
            return (
                ...
                <td>              
                      <button class="btn btn-default" type="button" style={divStyle} onClick={this.onClickStart(topic.sensorId)} >Start</button> 
                <button class="btn btn-default" type="button" style={divStyle} onClick={this.onClickDelete(topic.sensorId)} >Stop </button> 
